...
| <a name="output_google_managed_notebook_id"></a> [google\_managed\_notebook\_id](#output\_google\_managed\_notebook\_id) | an identifier for the notebooks with format projects/{{project}}/global/firewalls/{{name}} |
